...
export const actions = {
	...
	async delete({commit, rootState, dispatch}, {type, serviceUserId}) {
		...
		const res = await Api.deleteUserService(params, rootState.user.authorizationToken)
	...
	async linkCallbackFromTwitter({ commit, rootState, dispatch }, { oauthToken, oauthVerifier, tmpOauthToken, tmpOauthTokenSecret }) {
		const params = {
		...
		const res = await Api.linkCallbackFromTwitter(params, rootState.user.authorizationToken)
