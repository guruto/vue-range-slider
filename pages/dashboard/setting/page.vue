<template>
  <div class="p-setting__page">
            ...
            <div class="p-form__group">
              ...
              <div class="p-form__item">
                <input
                  ...
                  type="text"
                  :class="{ 'is-error': errors.has('pageLabel') }"
                  name="pageLabel"
            ...
            <div class="p-form__group">
              ...
              <div class="p-form__item">
                <input
                  ...
                  v-validate="'required|min:3|max:30'"
                  type="text"
                  :class="{ 'is-error': errors.has('pageName') }"
                  name="pageName"
                  placeholder="サイト名を入力"
                >
              </div>
            ...
            <div class="p-form__group">
              ...
              <div class="p-setting-page__link__sns">
                <div class="p-form__group">
                  ...
                  <div class="p-form__item">
                    <span
                      class="p-setting-page__link__sns__logo p-setting-page__link__sns__logo--twitter"
                    />
                    <input
                      v-model="twitterId"
                      type="text"
                ...
                <div class="p-form__group">
                  ...
                  <div class="p-form__item">
                    <span
                      class="p-setting-page__link__sns__logo p-setting-page__link__sns__logo--instagram"
                    />
                    <input
                      v-model="instagramId"
                      type="text"
                ...
                <div class="p-form__group">
                  ...
                  <div class="p-form__item">
                    <span
                      class="p-setting-page__link__sns__logo p-setting-page__link__sns__logo--line"
                    />
                    <input
                      v-model="lineId"
                      type="text"
                ...
                <div class="p-form__group">
                  ...
                  <div class="p-form__item">
                    <span
                      class="p-setting-page__link__sns__logo p-setting-page__link__sns__logo--facebook"
                    />
                    <input
                      v-model="facebookId"
                      type="text"
              ...
              <div class="p-setting-page__link__other">
                <div class="p-setting-page__link__other__content">
                  ...
                  <ul>
                    <li
                      v-for="(link, linkIndex) in this.links"
                      class="p-setting-page__link__other__content__item"
                    >
                      <!--											<div class="is-drag">-->
                ...
                <div class="p-setting-page__link__other__add">
                  <button
                    type="button"
                    class="c-btn"
                    @click="handleAddLinkOther"
                  >
                    <i class="material-icons">add</i>リンクを追加する
                  </button>
                </div>
              </div>
            </div>
    ...
    <div
      v-show="isShowPopoverMoreControlLink"
      id="link-popover"
      class="p-popover"
    >
      ...
      <div class="p-popover__body">
        <ul>
          <li @click="handleLinkItemEdit">
            編集する
          </li>
          <li class="is-delete" @click="handleLinkItemDelete">
            削除する
          </li>
        </ul>
      </div>
    ...
    <Modal
      ...
      :initial-page-link-url="modalLinkUrl"
      :on-handle-action="handleExecuteLinkModalAction"
    />
  </div>
</template>
    ...
    handleMoreOtherLink(e) {
      ...
      if (this.isShowPopoverMoreControlLink) {
        ...
        document.body.removeEventListener(
          "click",
          this.handlePopoverClickOutside
        )
      }
    },
    handlePopoverClickOutside(e) {
      if (
        e.target.className != "is-more" &&
        e.target.className != "material-icons is-more-icon"
      ) {
  ...
  &__link {
    &__sns {
      ...
      &__logo {
        ...
        &--instagram {
          background: url("/img/icon_setting_instagram@2x.png") center center /
              18px 18px no-repeat,
            linear-gradient(
              to bottom,
              #7024c4 0%,
