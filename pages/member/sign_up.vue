  ...
  <div class="p-member-sign_up">
    ...
    <section class="c-section">
      ...
      <p>
        「{{
          page.name
        }}」にメンバー登録すると、メンバー限定投稿が閲覧できたり、新規投稿の通知を受けることができます。
      </p>
      <p>
        ※メールアドレスなどの個人情報はサイト運営者から見られることはありません。
      </p>

      <div class="p-login">
        <div
          v-if="this.$store.state.user.authenticated"
        ...
        >
          <button
            ...
            type="button"
            :disabled="isLoading"
            @click="handleSubscribeForAuthenticated"
          >
            メンバー新規登録
          </button>
        </div>
            ...
            <div class="p-login__service__item">
              <button
                ...
                :class="{
                  'c-btn': true,
                  'is-twitter': true,
                  'is-loading': isLoadingSignUpTwitter
                }"
                @click="handleMemberSignUpTwitter"
              >
                <img
            ...
            <div class="p-form">
              <form @submit.prevent="memberSignUp">
                ...
                <div class="p-form__button">
                  ...
                  <p class="p-form__button__agreement">
                    <a href="/info/term">利用規約</a>・<a href="/info/privacy">プライバシーポリシー</a>
                  </p>
                </div>
                <div class="p-form__button">
                  <nuxt-link class="c-btn c-btn--default" to="/member/login">
                    メンバー登録済みの場合はログインへ
                  </nuxt-link>
                </div>
              </form>
  ...
  async asyncData(context) {
    ...
    return {
      ...
      meta: {
        ...
        description:
          context.store.state.page.name + "のメンバー登録ページです。",
