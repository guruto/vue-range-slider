	...
	<div class="p-about">
		...
		<section class="c-section">
			...
			<div class="p-about__profile">
				<h2 class="c-title--sub">プロフィール</h2>
				<div class="p-about__profile__content">
					<div class="p-about__profile__content__head">
						<div class="p-about__profile__content__thumbnail">
							<span class="p-about__profile__content__thumbnail__image" :style="'background-image: url(' + profile.iconImageUrl + ')'"></span>
						</div>
		...
		if (context.store.state.page.isError) {
			...
			return {
				...
				meta: {
					...
					description: context.store.state.page.description ? context.store.state.page.description : context.store.state.page.name + 'のABOUTページです。',
