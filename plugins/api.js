  ...
  response => {
    ...
    if (response.data.is_error === "0") {
      return Promise.resolve({
        ...
        success_message:
          response.data.hasOwnProperty("success_message") &&
          response.data.success_message.length > 0
...
export default {
  ...
  linkCallbackFromTwitter(params, authorizationToken) {
    return apiPost(
      "user_services/link_callback_from_twitter",
      params,
      authorizationToken
    )
  },
  ...
  getMemberListBelongToMyPage(params, authorizationToken) {
    return apiGet(
      "members/get_list_belong_to_my_page",
      params,
      authorizationToken
    )
  },
  ...
  getPostList(pageLabel, params, authorizationToken) {
    return apiGet(
      "posts/get_list_by_page_label/" + pageLabel,
      params,
      authorizationToken
    )
  },
  ...
  getPageListMemberBelongedMyself(params, authorizationToken) {
    return apiGet(
      "pages/get_list_member_belonged_myself",
      params,
      authorizationToken
    )
  },
