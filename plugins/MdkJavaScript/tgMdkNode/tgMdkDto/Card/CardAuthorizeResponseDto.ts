...
@JsonObject("CardAuthorizeResponseDto")
export class CardAuthorizeResponseDto extends MdkDtoBase implements IResponseDto {
    ...
    @JsonProperty("resGiftBalance", String, true)
    resGiftBalance: string = undefined;

    @JsonProperty("resGiftExpire", String, true)
