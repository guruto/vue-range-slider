<template>
  <div>
    ...
    <div
      v-if="!readOnly"
      class="p-editor medium-editor-container"
      @click="handleEditorClick"
    >
      <div
        ref="editor"
        class="p-editor__content editor"
        :class="editorClass"
        v-html="prefill"
      >
        >
      ...
      <insert-embed
        ...
        :on-handle-insert-link="handleInsertLink"
      />
    ...
    <!-- Read Only Mode -->
    <read-mode v-if="readOnly" :content="prefill" />
  </div>
</template>
...
export default {
  ...
  props: ["options", "onChange", "prefill", "readOnly", "onHandleSaveContent"],
  data() {
    return {
      editor: null,
      defaultOptions: {
