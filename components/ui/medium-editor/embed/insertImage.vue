<template>
  <span
    class="btn-toggle file-uploads file-uploads-html5 p-editor__embed__btn__image"
    @click="handleSelectTextImage"
  >
    <i class="far fa-images" />
    <input
      id="form-select-text-image"
      type="file"
      accept="image/*"
      @change="handleTextImageFile"
    >
  </span>
</template>
