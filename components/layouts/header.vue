<template>
	<header :class="{'l-header': true, 'is-top-index': isTopIndex, 'is-top-page': isTopPage, 'is-user-page': isUserPage}">
		<div class="l-header__content">

			<div class="l-header__content__drawer-toggle">
				<div class="l-header__content__drawer-toggle__content" role="button" @click="$store.dispatch('navigation/toggleSidebar', {isTopPage: isTopPage, isUserPage: isUserPage})">
					<div class="l-header__content__drawer-toggle__content__item"></div>
					<div class="l-header__content__drawer-toggle__content__item"></div>
					<div class="l-header__content__drawer-toggle__content__item"></div>
				</div>
			</div>
			...
			<div class="l-header__content__logo">
				<div v-if="isUserPage">
					<nuxt-link to="/">
						<span v-if="this.$store.state.page.label">{{this.$store.state.page.name}}</span>
